package 
{
	...
	{					
		...
		public static function exportDGToClipboard (grid:DataGrid, csv:Boolean = true, onlySelected:Boolean = true):String
		{
			System.setClipboard(exportDGToCSV (grid, csv, onlySelected));
			return exportDGToCSV (grid, csv, onlySelected);
		}
		
		public static function exportADGToClipboard (grid:AdvancedDataGrid, csv:Boolean = true, onlySelected:Boolean = true):String
		{
			System.setClipboard(exportADGToCSV (grid, csv, onlySelected));
			return exportADGToCSV (grid, csv, onlySelected);
		}
		...
		public static function exportGridToCSV (grid:Object, csv:Boolean, onlySelected:Boolean):String
		{
